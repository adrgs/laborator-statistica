#' ---
#' title: "Tema1.R - Probabilitati si Statistica"
#' author: "Student: Albastroiu Dragos, grupa 251"
#' date: ""
#' ---
...
#' Observam ca raspunsul a dat diferit in acest caz. Pachetul discreteRV are probleme atunci cand in dreapta semnului este un numar negativ.
#' Putem sa rescriem Y < -2 ca -Y > 2, dar trebuie sa folosim repartitia comuna a celor doua v.a. pentru a obtine valoarea buna
